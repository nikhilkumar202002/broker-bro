...
export default function PropertyTypeForm({ onSuccess, onClose, initialData }) {
  ...
  const handleSubmit = (e) => {
    ...
    console.debug('[PropertyTypeForm] Submitting:', { 
      isEditing, 
      hasToken: !!token, 
    ...
    toast.promise(apiPromise, {
      ...
      success: (res) => {
        console.debug('[PropertyTypeForm] Success:', res);
      ...
      error: (err) => {
        console.error('[PropertyTypeForm] Error:', err);
        return null;
      },
    }).catch((err) => {
      console.error('[PropertyTypeForm] Caught error:', err);
    });
  };
