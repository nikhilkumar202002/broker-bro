  ...
  return (
    <aside className="hidden md:flex flex-col w-64 bg-gray-900 min-h-screen text-white transition-all duration-300">
      ...
      <div className="p-4 border-t border-gray-800">
        <button className="flex items-center gap-3 px-3 py-2.5 w-full rounded-lg text-gray-300 hover:bg-red-500/10 hover:text-red-500 transition-colors font-medium">
          <svg className="w-5 h-5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
